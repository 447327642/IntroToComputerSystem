...
int howManyBits(int x) {
    ...
    int help3 = 0x7f;
    int help5 = 0x1<<31;
    int help4 = (help5 >> 16)+help5;
    int special =  ~(x & (rever)) & rever;
    
    help0 = (help0<<8) + 0x55;
    help0 = (help0 << 16) + help0;
    help1 = (help1 << 8) +0x66;
    help1 = (help1<<16) + help1;
    help2 = (help2 << 8)+0x78 ;
    help2 = (help2 << 16) + help2;
    help3 = (help3 << 8) +0x80;
    help3 = (help3<< 16) + help3;
    //printf("%x special\n",special);
    num = (sign&(rever)) | ((~sign)&x);
    ...
    //printf("%x prenum\n", num);
    num = num + (~(num >> 1)+0x1);
    count = (!!(num&help0))| ((!!(num&help1))<<1)|((!!(num&help2))<<2);
     //printf("%x count\n", count);
    count = count|((!!(num&help3))<<3)|((!!(num&help4))<<4)|((!!(num&help5))<<5);
    
    //printf("%x sign\n", sign);
   
    
    result = count + ~(!special&0x1)+ 0x2;
...
unsigned float_i2f(int x) {
    ...
    if (count<0){
        para = 1<<(-count); //bit24 detection for round
    ...
    if (exp > 150){
        ...
        while(exp>150){
           ...
           // printf("%x exp\n", exp);
            ...
            if ( (content&0x80000000) == 0x80000000)
            {
                content = 0x80000000u;
                overflow = 1;
                break;
